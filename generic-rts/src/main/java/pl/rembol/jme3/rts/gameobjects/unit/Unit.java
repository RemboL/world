...
abstract public class Unit implements Selectable,
    ...
    public Unit(RtsGameState gameState) {
        this.gameState = gameState;
        initNode(null);
    }

    public Unit(RtsGameState gameState, Vector3f position) {
        this(gameState);
    ...
    protected MovingPhysicsControl createCharacterControl(RtsGameState gameState) {
        return new CharacterBasedControl(gameState, .6f * getWidth(), 10f, getWidth() * getWidth());
    }
    ...
    abstract protected SelectionIcon createIcon(RtsGameState gameState);
