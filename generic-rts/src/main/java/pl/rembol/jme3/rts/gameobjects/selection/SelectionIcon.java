...
public class SelectionIcon extends ClickablePicture {
    ...
    private SelectionIcon(RtsGameState gameState, Selectable selectable) {
        super(gameState);
    ...
    public SelectionIcon(RtsGameState gameState, Selectable selectable, String iconName) {
    ...
    public SelectionIcon(RtsGameState gameState, Selectable selectable, Spatial model) {
        this(gameState, selectable);
